...
const NAV_ICONS = {
  ...
  kwork:
    '<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5" fill="currentColor" opacity="0.15"/><text x="12" y="16.5" text-anchor="middle" fill="currentColor" font-size="12" font-weight="800" font-family="Inter,Arial,sans-serif">K</text></svg>',
};
...
function updateGreeting() {
  ...
  const name = currentUserData.firstName || currentUserData.email?.split("@")[0] || "коллега";
